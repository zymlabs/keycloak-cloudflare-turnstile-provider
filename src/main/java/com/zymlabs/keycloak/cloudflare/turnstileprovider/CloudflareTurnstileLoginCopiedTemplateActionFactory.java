...
/**
 * Factory for CloudflareTurnstileLoginCopiedTemplateAction.
 * This is Option 3 for Login: Copied Template - bundles modified login.ftl in JAR.
 */
public class CloudflareTurnstileLoginCopiedTemplateActionFactory implements FormActionFactory {

    public static final String PROVIDER_ID = "cloudflare-turnstile-login-copied-template-action";

    @Override
    public String getDisplayType() {
        return "Cloudflare Turnstile - Login (Copied Template)";
    }
    ...
    public String getHelpText() {
        return "Renders Cloudflare Turnstile widget using a bundled login.ftl template in the JAR. " +
                "Works without custom themes, but requires template maintenance when upgrading Keycloak. " +
                "The widget appears natively embedded in the login form. " +
    ...
    public FormAction create(KeycloakSession session) {
        return new CloudflareTurnstileLoginCopiedTemplateAction();
    }
