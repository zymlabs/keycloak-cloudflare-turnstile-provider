...
/**
 * Factory for CloudflareTurnstileLoginScriptInjectionAction.
 * This is Option 2 for Login: Script Injection - injects Turnstile widget via JavaScript.
 */
public class CloudflareTurnstileLoginScriptInjectionActionFactory implements FormActionFactory {

    public static final String PROVIDER_ID = "cloudflare-turnstile-login-script-injection-action";

    @Override
    public String getDisplayType() {
        return "Cloudflare Turnstile - Login (Script Injection)";
    }
    ...
    public String getHelpText() {
        return "Injects Cloudflare Turnstile widget into login form using JavaScript DOM manipulation. " +
                "Works with any theme without template modifications. The widget appears inline before the submit button. " +
                "Server-side validation ensures security even if JavaScript is bypassed.";
    }
    ...
    public FormAction create(KeycloakSession session) {
        return new CloudflareTurnstileLoginScriptInjectionAction();
    }
