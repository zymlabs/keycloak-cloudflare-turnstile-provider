...
/**
 * Factory for CloudflareTurnstileRegistrationAuthenticator.
 * Provides configuration UI and creates authenticator instances for registration flows.
 */
public class CloudflareTurnstileRegistrationAuthenticatorFactory implements AuthenticatorFactory {

    public static final String PROVIDER_ID = "cloudflare-turnstile-registration-authenticator";
    private static final CloudflareTurnstileRegistrationAuthenticator SINGLETON = new CloudflareTurnstileRegistrationAuthenticator();

    @Override
    public String getDisplayType() {
        return "Cloudflare Turnstile (Registration)";
    }
    ...
    public String getHelpText() {
        return "Validates users with Cloudflare Turnstile CAPTCHA before registration. Displays a separate verification page before the registration form. Most stable option with zero theme dependencies.";
    }
