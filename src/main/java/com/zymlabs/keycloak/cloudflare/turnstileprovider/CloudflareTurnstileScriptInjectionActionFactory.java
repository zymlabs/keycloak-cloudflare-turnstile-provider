...
/**
 * Factory for CloudflareTurnstileScriptInjectionAction.
 * Provides FormAction that injects Turnstile widget via JavaScript - no theme modifications needed.
 */
public class CloudflareTurnstileScriptInjectionActionFactory implements FormActionFactory {

    public static final String PROVIDER_ID = "cloudflare-turnstile-script-injection-action";
    private static final CloudflareTurnstileScriptInjectionAction SINGLETON = new CloudflareTurnstileScriptInjectionAction();

    @Override
    public String getDisplayType() {
        return "Cloudflare Turnstile (Script Injection)";
    }
    ...
    public String getHelpText() {
        return "Injects Cloudflare Turnstile widget into registration form via JavaScript (DOM manipulation). No theme modifications required. Works with any theme, but requires JavaScript enabled and may have CSP compatibility issues.";
    }
