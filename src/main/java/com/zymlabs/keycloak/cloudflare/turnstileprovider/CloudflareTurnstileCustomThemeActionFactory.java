...
/**
 * Factory for CloudflareTurnstileCustomThemeAction.
 * Provides FormAction that uses the bundled "turnstile" theme for native integration.
 */
public class CloudflareTurnstileCustomThemeActionFactory implements FormActionFactory {

    public static final String PROVIDER_ID = "cloudflare-turnstile-custom-theme-action";
    private static final CloudflareTurnstileCustomThemeAction SINGLETON = new CloudflareTurnstileCustomThemeAction();

    @Override
    public String getDisplayType() {
        return "Cloudflare Turnstile (Custom Theme)";
    }
    ...
    public String getHelpText() {
        return "Renders Cloudflare Turnstile widget using the bundled 'turnstile' theme. Requires selecting the 'turnstile' theme in Realm Settings → Themes → Login Theme. Provides the most standard Keycloak theme integration approach.";
    }
