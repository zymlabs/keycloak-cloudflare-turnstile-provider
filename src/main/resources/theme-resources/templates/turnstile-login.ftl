            ...
            <#if realm.password>
                <form id="kc-form-login" onsubmit="login.disabled = true; return true;" action="${url.loginAction}" method="post">
                    ...
                    <div class="${properties.kcFormGroupClass!} ${properties.kcFormSettingClass!}">
                      ...
                      <#-- Cloudflare Turnstile Widget - Injected by Copied Template Option -->
                      <#if turnstileRequired?? && turnstileRequired && !turnstileSkipped??>
                          <div class="${properties.kcFormGroupClass!}" style="margin: 20px 0;">
